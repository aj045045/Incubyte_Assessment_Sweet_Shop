    ...
    <div className="text-center">
      ...
      <div className="max-w-screen-xl mx-auto py-24 grid md:grid-cols-2 lg:grid-cols-3 gap-16 md:gap-10 px-6 md:px-0">
        ...
        <div className="text-center flex flex-col items-center">
          ...
          <p className="mt-2 text-muted-foreground">
            Visit our headquarters in the heart of Gujarat.
          </p>
          <Link
            className="mt-4 font-medium text-primary text-center"
            href="https://maps.google.com/?q=Ahmedabad, Gujarat, India"
            target="_blank"
          >
            100 Ellis Bridge Road,<br />
        ...
        <div className="text-center flex flex-col items-center">
          ...
          <p className="mt-2 text-muted-foreground">Mon–Fri, 10am – 6pm IST</p>
          <Link
            className="mt-4 font-medium text-primary"
